...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['min_support']) || empty($_POST['min_confidence'])) {
        $can_process = false;
        ?>
        <script> location.replace("?menu=view_rule_hashbased&pesan_error=Min Support dan Min Confidence harus diisi");</script>
        <?php
    }
    if(!is_numeric($_POST['min_support']) || !is_numeric($_POST['min_confidence'])){
        $can_process = false;
        ?>
        <script> location.replace("?menu=view_rule_hashbased&pesan_error=Min Support dan Min Confidence harus diisi angka");</script>
        <?php
    }
    ...
    $sql = "SELECT
            ...
            FROM
             confidence_hashbased conf, process_log_hashbased log
    ...
    $sql_log = "SELECT * FROM process_log_hashbased
    WHERE id = ".$id_process;
...
//            else{
            ...
            ?>
                    ...
                    ?>
                                        ...
                                        <h2>Hasil Analisa</h2>
                                        <a href="export/CLP_hashbased.php?id_process=<?php echo $id_process; ?>" class="btn btn-outline-secondary" target="blank">
