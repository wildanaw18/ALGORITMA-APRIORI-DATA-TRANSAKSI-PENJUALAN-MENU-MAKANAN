...
<body>
            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="assets/themesbrand.com/assets/images/logo-dark.png" alt="" height="17">
                        </span>
                    </a>
                    ...
                    <a href="index.html" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="assets/themesbrand.com/assets/images/logo-light.png" alt="" height="17">
                        </span>
                    </a>
                </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="assets/themesbrand.com/assets/images/users/avatar-1.jpg"
                                alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo ($_SESSION['apriori_parfum_level']==1)?"Administrator":"Pemilik RM" ?></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome <?php echo $_SESSION['apriori_parfum_level_name'] ?></h6>
    ...
    <!-- apexcharts -->
    <script src="assets/themesbrand.com/assets/libs/apexcharts/apexcharts.min.js"></script>
    ...
    <script src="assets/themesbrand.com/assets/js/pages/datatables.init.js"></script>
    <!-- Dashboard init -->
    <script src="assets/themesbrand.com/assets/js/pages/dashboard-analytics.init.js"></script>
    ...
    <!-- App js -->
    <script src="assets/themesbrand.com/assets/js/app.js"></script>
   
</body>


<!-- Mirrored from themesbrand.com/velzon/html/default/dashboard-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Oct 2022 06:23:01 GMT -->
</html>