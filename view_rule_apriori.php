...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT
            ...
            FROM
             confidence_apriori conf, process_log_apriori log
    ...
    $sql_log = "SELECT * FROM process_log_apriori
    WHERE id = ".$id_process;
...
//            else{
            ...
            ?>
                    ...
                    ?>
                                        ...
                                        <h2>Hasil Analisa</h2>
                                        <a href="export/CLP_apriori.php?id_process=<?php echo $id_process; ?>" class="btn btn-outline-secondary" target="blank">
