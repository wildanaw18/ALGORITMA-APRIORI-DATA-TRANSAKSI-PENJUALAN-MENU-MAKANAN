                                        ...
                                        <tbody>
                                           <?php
                                                ...
                                                while($row=$db_object->db_fetch_array($query)){
                                                        ...
                                                        $view = "<a href='index.php?menu=view_rule_hashbased&id_process=".$row['id']."'>View rule</a>";
                                                        echo "<td>".$view."</td>";
                                                        echo "<td>";
                                                        echo "<a href='export/CLP_hashbased.php?id_process=".$row['id']."' "
